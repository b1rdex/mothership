 ...
 */
final class Version20200825123059 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , ticker_symbol VARCHAR(255) NOT NULL, CONSTRAINT FK_F5299398CF2FC8D0 FOREIGN KEY (terminal_id_id) REFERENCES terminal (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO "order" (id, terminal_id_id, ticker_symbol, magic_number, type, lots, open_price, close_price, sl, tp, swap, profit, status, error_message, created_at, updated_at) SELECT id, terminal_id_id, ticker, magic_number, type, lots, open_price, close_price, sl, tp, swap, profit, status, error_message, created_at, updated_at FROM __temp__order');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE "order"');
        $this->addSql('CREATE TABLE "order" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, terminal_id_id INTEGER NOT NULL, magic_number VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, lots INTEGER NOT NULL, open_price NUMERIC(10, 2) NOT NULL, close_price NUMERIC(10, 2) DEFAULT NULL, sl NUMERIC(20, 10) DEFAULT NULL, tp NUMERIC(20, 10) DEFAULT NULL, swap NUMERIC(10, 2) DEFAULT NULL, profit NUMERIC(10, 2) DEFAULT NULL, status VARCHAR(255) NOT NULL, error_message VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , updated_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , ticker VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO "order" (id, terminal_id_id, ticker, magic_number, type, lots, open_price, close_price, sl, tp, swap, profit, status, error_message, created_at, updated_at) SELECT id, terminal_id_id, ticker_symbol, magic_number, type, lots, open_price, close_price, sl, tp, swap, profit, status, error_message, created_at, updated_at FROM __temp__order');
        $this->addSql('DROP TABLE __temp__order');
        $this->addSql('CREATE INDEX IDX_F5299398CF2FC8D0 ON "order" (terminal_id_id)');
    }
}
