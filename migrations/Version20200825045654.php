 ...
 */
final class Version20200825045654 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , balance NUMERIC(10, 2) NOT NULL, free_margin NUMERIC(10, 2) NOT NULL, is_main BOOLEAN NOT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
